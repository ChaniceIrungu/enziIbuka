...
const ORDER_TABLE = "Order-zqlkaqcswnbshccvngu3cgx7tq-prod";
const ORDER_TYPE = "Order";
const PRODUCT_ORDER_TABLE = "ProductOrder-zqlkaqcswnbshccvngu3cgx7tq-prod";
...
exports.handler = async (event) => {
  try {
    ...
    // links Product with the order
    await createProductOrder(payload);
// many to may relationship between order and product
